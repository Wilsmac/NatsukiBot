...
sendGroupV4Invite: {
    ...
    lister.slice(1).forEach(sectionData => {
        const sectionTitle = sectionData[0]; 
        const rows = sectionData.slice(1);   

        const sectionRows = Array.from(rows);
