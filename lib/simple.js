...
let canalId = ["120363192435027853@newsletter", "120363192435027853@newsletter", "120363192435027853@newsletter", "120363192435027853@newsletter"]
let canalNombre = ["『✯ Team Comunity Natsuki 』", "『✯ Team Comunity Natsuki 』", "『✯ Team Comunity Natsuki 』", "『✯ Team Comunity Natsuki 』"]
...
return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text, contextInfo: { mentionedJid: null, forwardedNewsletterMessageInfo: { newsletterJid: randomChannel.id, serverMessageId: '', newsletterName: randomChannel.nombre }, forwardingScore: 1, isForwarded: true, ...options }}, { quoted, ...options })
}
},
