...
phNumber: (chalk) => `Configurar archivo ${chalk.bold.greenBright("config.js")} el número ingresado no tiene código de país. ${chalk.bold.yellowBright("Ejemplo: +50250917388")}`,
