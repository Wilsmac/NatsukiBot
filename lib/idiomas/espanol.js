...
const smsRestrictdesc = () => { return `EL RESTRICT ESTA ACTUALMENTE DESACTIVADO POR MI CREADOR(A)` }
const smsRestrict = () => { return `\`\`\`¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙴𝚂𝚃𝙰 𝚁𝙴𝚂𝚃𝚁𝙸𝙽𝙶𝙸𝙳𝙾 𝙿𝙾𝚁 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁!\`\`\`` }//RESTRINGIR COMANDO
