...
const smsUnreg = () => { return `\`\`\`¡𝙽𝙴𝙲𝙴𝚂𝙸𝚃𝙰𝚂 𝙴𝚂𝚃𝙰𝚁 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝙳𝙾(𝙰) 𝙿𝙰𝚁𝙰 𝚈𝚂𝙰𝚁 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾, 𝙴𝚂𝙲𝚁𝙸𝙱𝙴 .verificar 𝙿𝙰𝚁𝙰 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝚁𝚂𝙴!\`\`\`` }//VERIFICAR
