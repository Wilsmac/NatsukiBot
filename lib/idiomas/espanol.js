...
const smsRowner = () => { return `\`\`\`╭━─━─━──━━━─≪✠≫─━━─━─━━━━─━╮\n¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾́𝙻𝙾 𝚈𝙾 𝙲𝙾𝙼𝙾 𝙲𝚁𝙴𝙰𝙳𝙾𝚁 𝙳𝙴𝙻 𝙱𝙾𝚃 𝙿𝚄𝙴𝙳𝙴 𝚄𝚂𝙰𝚁!\n╰━─━─━─━──━─≪✠≫─━─━──━─━━─━╯\`\`\`` }//NUMERO DE BOT
const smsOwner = () => { return `\`\`\`╭━─━─━──━━━─≪✠≫─━━─━─━━─━─━╮\n¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁 𝙻𝙾 𝙿𝚄𝙴𝙳𝙴 𝚄𝚂𝙰𝚁!\n╰━─━─━─━─━━─≪✠≫─━─━─━─━━━─━╯\`\`\`` }//OWNER
const smsMods = () => { return `\`\`\`╭━─━─━──━━━─≪✠≫─━━─━─━━─━─━╮\n¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙳𝙴𝚂𝙰𝚁𝙾𝙻𝙻𝙰𝙳𝙾𝚁𝙴𝚂 𝚈 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁 𝙿𝚄𝙴𝙳𝙴𝙽 𝚄𝚂𝙰𝚁!\n╰━─━─━─━─━━─≪✠≫─━─━──━──━─━╯\`\`\`\`` }//MODERADORES
const smsPremium = () => { return `\`\`\`¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙴𝚂 𝙳𝙴 𝚄𝚂𝙾 𝙿𝙾𝚁 𝚄𝚂𝚄𝙰𝚁𝙸𝙾𝚂 𝙿𝚁𝙴𝙼𝙸𝚄𝙼 𝚈 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁. 𝙿𝙰𝚁𝙰 𝚂𝙴𝚁 𝙿𝚁𝙴𝙼𝙸𝚄𝙼 𝚄𝚂𝙰𝚁 #premium\`\`\`` }//USUARIOS PREMIUM
const smsGroup = () => { return `\`\`\`╭━─━─━──━━━─≪✠≫─━━─━─━━─━─━╮\n¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾́𝙻𝙾 𝚂𝙴 𝙿𝚄𝙴𝙳𝙴 𝚄𝚂𝙰𝚁 𝙴𝙽 𝙶𝚁𝚄𝙿𝙾𝚂!\n╰━─━─━─━──━─≪✠≫─━─━──━─━━─━╯\`\`\`` }//PARA GRUPOS
const smsPrivate = () => { return `\`\`\`╭━─━─━─━─━━─≪✠≫─━━─━─━━─━─━╮\n¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝚂𝙴 𝙿𝚄𝙴𝙳𝙴 𝚄𝚂𝙰𝚁 𝙰𝙻 𝙿𝚁𝙸𝚅𝙰𝙳𝙾!\n╰━─━─━─━──━─≪✠≫─━─━──━─━━─━╯\`\`\`` }//AL PRIVADO
const smsAdmin = () => { return `\`\`\`╭━─━─━──━━━─≪✠≫─━━─━──━━━─━╮\n¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙴𝚂 𝙿𝙰𝚁𝙰 𝙰𝙳𝙼𝙸𝙽𝚂 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾!\n╰━─━─━─━──━─≪✠≫─━─━──━━─━─━╯\`\`\`` }//ADMINS
const smsBotAdmin = () => { return `\`\`\`╭━─━─━─━━━━─≪✠≫─━━─━──━─━─━╮\n¡𝙽𝙴𝙲𝙴𝚂𝙸𝚃𝙾 𝚂𝙴𝚁 𝙰𝙳𝙼𝙸𝙽 𝙿𝙰𝚁𝙰 𝚀𝚄𝙴 𝙿𝚄𝙴𝙳𝙰𝚂 𝚄𝚂𝙰𝚁 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾!\n╰━─━─━─━━─━─≪✠≫─━─━──━──━─━╯\`\`\`` }//BOT CON ADMIN
const smsUnreg = () => { return `\`\`\`¡𝙽𝙴𝙲𝙴𝚂𝙸𝚃𝙰𝚂 𝙴𝚂𝚃𝙰𝚁 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝙳𝙾(𝙰) 𝙿𝙰𝚁𝙰 𝚄𝚂𝙰𝚁 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾, 𝙴𝚂𝙲𝚁𝙸𝙱𝙴 .reg1 𝙿𝙰𝚁𝙰 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝚁𝚂𝙴!\`\`\`` }//VERIFICAR
const smsRestrict = () => { return `\`EL RESTRICT ESTA ACTUALMENTE DESACTIVADO POR MI CREADOR(A)\`` }//RESTRINGIR COMANDO

//MENU LISTA
const smsTime = () => { return `Tiempo Actual`}
const smsUptime = () => { return `Funcionando Durante`}
const smsVersion = () => { return `Versión de ${global.fantasy}`}
...
const smsTarde = () => { return `🏙️ Buenas Tardes`}
const smsTarde2 = () => { return `🌆 Buenas tardes`}
const smsNoche = () => { return `🌃 Buenas noches`}
const smsListaMenu = () => { return `⊹ 𝙻𝙸𝚂𝚃𝙰 𝙳𝙴 𝙼𝙴𝙽𝚄 ⊹`}
const smsLista1 = () => { return `☃️ 𝙸𝙽𝙵𝙾𝚁𝙼𝙰𝙲𝙸𝙾𝙽 𝙳𝙴𝙻 𝙱𝙾𝚃 ☃️`}
const smsLista2 = () => { return `🍁 𝙲𝚁𝙴𝙰𝙳𝙾𝚁🍁 `}
const smsLista3 = () => { return `🌱 𝙳𝙾𝙽𝙰𝚁 🌱`}
const smsLista4 = () => { return `🚀 𝚅𝙴𝙻𝙾𝙲𝙸𝙳𝙰𝙳 🚀`}
const smsLista5 = () => { return `📄 𝙸𝙽𝙵𝙾 𝙳𝙴𝙻 𝙼𝙴𝙽𝚄 📄`}
const smsLista6 = () => { return `📚 𝙼𝙴𝙽𝚄 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙾 📚`}
const smsLista7 = () => { return `🌟 𝙸𝙽𝚂𝚃𝙰𝙻𝙰𝚁 𝙴𝙻 𝙱𝙾𝚃 🌟`}
const smsLista8 = () => { return `♦️ 𝚂𝙴𝚁 𝙱𝙾𝚃 𝙲𝙾𝙳𝙴 ♦️`}
const smsLista9 = () => { return `🌻 𝚃𝙴𝚁𝙼𝙸𝙽𝙾𝚂 𝚈 𝙿𝚁𝙸𝚅𝙰𝙲𝙸𝙳𝙰𝙳 🌻`}
...
const smsLista15 = () => { return `⚗️ 𝙼𝙴𝙽𝚄 𝚁𝙿𝙶 ⚗️`}
const smsLista16 = () => { return `🏪 TIENDA DE COMPRA Y VENTA 🏪`}
const smsLista17 = () => { return `📥 𝙸𝙽𝚅𝙴𝙽𝚃𝙰𝚁𝙸𝙾 📥`}
const smsLista18 = () => { return `❄️ MULTIMEDIA ❄️`}
const smsLista19 = () => { return `📲 𝙼𝙴𝙽𝚄 𝙳𝙴𝚂𝙲𝙰𝚁𝙶𝙰𝚂 📲`}
const smsLista20 = () => { return `🔍 𝙼𝙴𝙽𝚄 𝙱𝚄𝚂𝚀𝚄𝙴𝙳𝙰𝚂 🔍`}
const smsLista21 = () => { return `🛰️ 𝙼𝙴𝙽𝚄 𝙲𝙾𝙽𝚅𝙴𝚁𝚃𝙸𝙳𝙾𝚁 🛰️`}
const smsLista22 = () => { return `🧿 𝙼𝙴𝙽𝚄 𝙳𝙴 𝙲𝙾𝙳𝙸𝙵𝙸𝙲𝙰𝙳𝙾𝚁 𝙳𝙴 𝙰𝚄𝙳𝙸𝙾𝚂 🧿`}
const smsLista22_1 = () => { return `🔩 𝙼𝙴𝙽𝚄 𝙳𝙴 𝙷𝙴𝚁𝚁𝙰𝙼𝙸𝙴𝙽𝚃𝙰𝚂 🔩`}
const smsLista23 = () => { return `🔮 𝙳𝙸𝚅𝙴𝚁𝚂𝙸𝙾𝙽 🔮`}
const smsLista24 = () => { return `🧸 𝙹𝚄𝙴𝙶𝙾 𝙳𝙸𝙽𝙰𝙼𝙸𝙲𝙾𝚂 🧸`}
const smsLista25 = () => { return `🔊 𝙼𝙴𝙽𝚄 𝙳𝙴 𝙰𝚄𝙳𝙸𝙾𝚂 🔊`}
const smsLista26 = () => { return `🎃 𝙼𝙴𝙽𝚄 𝙳𝙴 𝚂𝚃𝙸𝙲𝙺𝙴𝚁𝚂 𝚈 𝙵𝙸𝙻𝚃𝚁𝙾𝚂 🎃`}
const smsLista27 = () => { return `📚 𝙼𝙴𝙽𝚄 𝙳𝙴 𝙴𝙵𝙴𝙲𝚃𝙾𝚂 𝚈 𝙻𝙾𝙶𝙾𝚂 📚`}
const smsLista28 = () => { return `𝙼𝙴𝙽𝚄 𝙻𝙾𝙶𝙾 2 📚`}
const smsLista29 = () => { return `⛩️ 𝙼𝙴𝙼𝙴𝚂 𝚁𝙰𝙽𝙳𝙾𝙼 : 𝙰𝙽𝙸𝙼𝙴 ⛩️`}
const smsLista30 = () => { return `𝙼𝙴𝙽𝚄 𝙻𝙰 𝙱𝙸𝙱𝙻𝙸𝙰 🔞`}
const smsLista31 = () => { return `☄️ 𝙰𝙹𝚄𝚂𝚃𝙴𝚂 ☄️`}
const smsLista32 = () => { return `🍃 𝙼𝙴𝙽𝚄 𝙿𝙰𝚁𝙰 𝙶𝚁𝚄𝙿𝙾𝚂 🍃`}
const smsLista33 = () => { return `🪷 𝙻𝙸𝚂𝚃𝙰 𝙳𝙸𝚂𝙿𝙾𝙽𝙸𝙱𝙻𝙴𝚂 🪷`}
const smsLista34 = () => { return `⚙️ 𝙲𝙴𝙽𝚃𝚁𝙾 𝙳𝙴 𝙲𝙾𝙽𝙵𝙸𝙶𝚄𝚁𝙰𝙲𝙸𝙾𝙽 ⚙️`}
const smsLista35 = () => { return `🍁 𝙼𝙴𝙽𝚄 𝙿𝚁𝙰 𝙼𝙸 𝙿𝚁𝙾𝙿𝙸𝙴𝚃𝙰𝚁𝙸𝙾(𝙰) 🍁`}

//main.js
const smsWelcome = () => { return `*╔══════❖•ೋ °ೋ•❖══════╗*\n*➢*@subject\n*➢*@user\n*➢* *BIENVENIDO, LEA LA DESCRIPCIÓN DEL GRUPO*\n${String.fromCharCode(8206).repeat(850)}\n@desc
*╚══════❖•ೋ° °ೋ•❖══════╝*`}
const smsBye = () => { return `*╔══════❖•ೋ°  °ೋ•❖══════╗*\n➢ *_UN USUARIO A SALIDO DEL GRUPO_*\n➢  ~*USUARIO*~⇴ @user
*╚══════❖•ೋ° °ೋ•❖══════╝*`}
...
//_allantilink.js
const smsTextoYT = () => { return ' 𝙉𝙖𝙩𝙨𝙪𝙠𝙞𝘽𝙤𝙩-𝙂𝘿 '} 
const smsApagar = () => { return '𝙳𝙴𝚂𝙰𝙲𝚃𝙸𝚅𝙰𝚁'} 
const smsEncender = () => { return '𝙰𝙲𝚃𝙸𝚅𝙰𝚁'} 
...
const eGataCoins = () => { return 'NatsukiCoins' }
const eGataTickers = () => { return '🎫 Tickers' } 
...
const smsANivel1 = () => { return `𝙽𝙸𝚅𝙴𝙻 𝙰𝚄𝚃𝙾𝙼𝙰𝚃𝙸𝙲𝙾`}
const smsANivel2 = () => { return `Sube de nivel a todos de manera automática`}
...
const smsModP1 = () => { return `𝙼𝙾𝙳𝙾 𝙿𝚄𝙱𝙻𝙸𝙲𝙾`}
const smsModP2 = () => { return `Habilitar función para que todos puedan usar al bot`}
const smsModAd1 = () => { return `𝙼𝙾𝙳𝙾 𝙰𝙳𝙼𝙸𝙽`}
const smsModAd2 = () => { return `Solo los Admins podrán usar al bot en Grupos`}
const smsLect1 = () => { return `𝙻𝙴𝙲𝚃𝚄𝚁𝙰 𝙰𝚄𝚃𝙾𝙼𝙰𝚃𝙸𝙲𝙰`}
...
const smsAntitoc1 = () => { return `𝙰𝙽𝚃𝙸 𝚃𝙾𝚇𝙸𝙲𝙾𝚂`}
...
const smsAntiEli1 = () => { return `𝙰𝙽𝚃𝙸 𝙴𝙻𝙸𝙼𝙸𝙽𝙰𝚁`}
...
const smsAntiEE1 = () => { return `𝙰𝙽𝚃𝙸 𝙴𝙽𝙻𝙰𝙲𝙴𝚂 : 2`}
...
const smsConfi6 = () => { return `✅ ⇢ 𝙵𝚄𝙽𝙲𝙸𝙾𝙽 𝙰𝙲𝚃𝙸𝚅𝙰𝙳𝙾`}
...
const smsConfi10 = () => { return `*~ 𝙲𝙾𝙽𝙵𝙸𝙶𝚄𝚁𝙰𝙲𝙸𝙾𝙽𝙴𝚂*`}
const smsParaAdmins = () => { return `PARA ADMINS Y MI CREADOR : GRUPOS`}
const smsParaAdYOw = () => { return `PARA ADMINS Y MI CREADOR : CHATS`}
const smsParaOw = () => { return `PARA CREADOR : CHATS`}
const smsNoGg = () => { return ` | ⚠️`}
const smsMens1 = () => { return `𝙲𝙾𝙼𝙰𝙽𝙳𝙾:`} 
const smsMens2 = () => { return `𝙰𝙲𝚃𝚄𝙰𝙻𝙼𝙴𝙽𝚃𝙴:`} 
...
//_antiviewonce.js
const smsAntiView = () => { return `𝙿𝚁𝙾𝙷𝙸𝙱𝙸𝙳𝙾 𝙾𝙲𝚄𝙻𝚃𝙰𝚁 𝙻𝙰 𝙸𝙼𝙰𝙶𝙴𝙽`} 
...
const smsGrupoTime7 = () => { return '🔒 𝙴𝙻 𝙶𝚁𝚄𝙿𝙾 𝙰𝙷 𝚂𝙸𝙳𝙾 𝙲𝙴𝚁𝚁𝙰𝙳𝙾, 𝚂𝙾𝙻𝙾 𝙰𝙳𝙼𝙸𝙽𝚂 𝙿𝙾𝙳𝚁𝙰𝙽 𝙴𝙽𝚅𝙸𝙰𝚁 𝙼𝙴𝙽𝚂𝙰𝙹𝙴𝚂.'}
const smsGrupoTime8 = () => { return '🔓 𝙴𝙻 𝙶𝚁𝚄𝙿𝙾 𝙵𝚄𝙴 𝙰𝙱𝙸𝙴𝚁𝚃𝙾, 𝚃𝙾𝙳𝙾𝚂 𝙻𝙾𝚂 𝙸𝙽𝚃𝙴𝙶𝚁𝙰𝙽𝚃𝙴𝚂 𝙿𝚄𝙴𝙳𝙴𝙽 𝙴𝚂𝙲𝚁𝙸𝙱𝙸𝚁.'}
...
// JadiBot
const smsSscrrd = () => { return `> 𝙻𝙰 𝙲𝙾𝙽𝙴𝚇𝙸𝙾𝙽 𝚂𝙴 𝙰𝙷 𝙲𝙴𝚁𝚁𝙰𝙳𝙾, 𝙳𝙴𝙱𝙴 𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝚁𝚂𝙴 𝙽𝚄𝙴𝚅𝙰𝙼𝙴𝙽𝚃𝙴 𝙲𝙾𝙽 𝙴𝙻 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 .botcode o .code 𝚈 𝚅𝚄𝙴𝙻𝚅𝙰 𝙰 𝙸𝙽𝙶𝚁𝙴𝚂𝙰𝚁 𝙴𝙻 𝙲𝙾𝙳𝙸𝙶𝙾.`}
const smsExit = () => { return `𝙲𝙾𝙽𝙴𝚇𝙸𝙾𝙽 𝙲𝙾𝙽 𝙴𝚇𝙸𝚃𝙾, 𝙿𝚄𝙴𝙳𝙴 𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝚁𝚂𝙴 𝙽𝚄𝚅𝙰𝙼𝙽𝚃𝙴 𝚄𝚂𝙰𝙽𝙳𝙾 𝚂𝚄 (ID)`}
const smsExit2 = () => { return `𝙲𝙾𝙽𝙴𝚇𝙸𝙾𝙽 𝙲𝙾𝙽 𝙴𝚇𝙸𝚃𝙾`}
const smsExitcnx = () => { return `𝚃𝙴 𝙷𝙰𝚂 𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝙳𝙾(𝙰), 𝙿𝙾𝚁\n𝙵𝙰𝚅𝙾𝚁 𝙴𝚂𝙿𝙴𝚁𝙴 𝚂𝙴 𝙴𝚂𝚃𝙰𝙽 𝙲𝙰𝚁𝙶𝙰𝙽𝙳𝙾 𝙻𝙾𝚂 𝙼𝙴𝙽𝚂𝙰𝙹𝙴𝚂...\n♻️*𝙾𝙿𝙲𝙸𝙾𝙽𝙴𝚂 𝙳𝙸𝚂𝙿𝙾𝙽𝙸𝙱𝙻𝙴𝚂:\n» #stop\n» #eliminarsesion\n» #code`}
const smsCodebt = () => { return `*࿇ ═━✥${global.gt}✥━═ ࿇*\n_𝙽𝚄𝙴𝚅𝙰 𝙵𝚄𝙽𝙲𝙸𝙾𝙽 𝙳𝙴 𝙷𝙰𝙲𝙴𝚁𝚃𝙴 𝚄𝙽 𝚂𝚄𝙱 𝙱𝙾𝚃_* 🌹\n> ➥ 𝙳𝚒𝚛𝚒𝚓𝚊𝚜𝚎 𝚎𝚗 𝚕𝚘𝚜 𝚝𝚛𝚎𝚜 𝚙𝚞𝚗𝚝𝚘𝚜 𝚎𝚗 𝚕𝚊 𝚎𝚜𝚚𝚞𝚒𝚗𝚊 𝚜𝚞𝚙𝚎𝚛𝚒𝚘𝚛 𝚍𝚎𝚛𝚎𝚌𝚑𝚊\n> ➥𝙸𝚛 𝚊 𝚕𝚊 𝚘𝚙𝚌𝚒𝚘𝚗 𝙳𝚒𝚜𝚙𝚘𝚜𝚒𝚝𝚒𝚟𝚘𝚜 𝚟𝚒𝚗𝚌𝚞𝚕𝚊𝚍𝚘𝚜\n> ➥ 𝚍𝚊 𝚌𝚕𝚒𝚌𝚔 𝚎𝚗 𝚟𝚒𝚗𝚌𝚞𝚕𝚊𝚛 𝚌𝚘𝚗 𝚌𝚘𝚍𝚒𝚐𝚘 𝚍𝚎 𝚝𝚎𝚕𝚎𝚏𝚘𝚗𝚘\n> ➥ 𝚙𝚎𝚐𝚊 𝚎𝚕 𝚌𝚘𝚍𝚒𝚐𝚘 𝚊 𝚌𝚘𝚗𝚝𝚒𝚗𝚞𝚊𝚌𝚒𝚘𝚗\n> 𝙹𝚊𝚍𝚒𝚋𝚘𝚝, 𝙷𝚎𝚌𝚑𝚘 𝚙𝚘𝚛 @Wilmer oficial 🌹`}
...
//jadibot-serbot.js
const smsIniJadi = () => { return `*࿇ ═━✥${global.gt}✥━═ ࿇\n🌹 *_FUNCIÓN SER SUB BOT_* 🌹\n\n*⟴ 𝙲𝚘𝚗 𝚘𝚝𝚛𝚘 𝚝𝚎𝚕𝚎́𝚏𝚘𝚗𝚘 𝚘 𝙿𝙲 𝚎𝚜𝚌𝚊𝚗𝚎𝚊 𝚎𝚜𝚝𝚎 𝚌𝚘́𝚍𝚒𝚐𝚘 𝚀𝚁 𝚙𝚊𝚛𝚊 𝚜𝚎𝚛 𝚜𝚞𝚋 𝚋𝚘𝚝*\n\n*⟴ 𝙳𝚒𝚛𝚒𝚓𝚎𝚜𝚎 𝚎𝚗 𝚕𝚘𝚜 𝚝𝚛𝚎𝚜 𝚙𝚞𝚗𝚝𝚘𝚜 𝚎𝚗 𝚕𝚊 𝚎𝚜𝚚𝚞𝚒𝚗𝚊 𝚜𝚞𝚙𝚎𝚛𝚒𝚘𝚛 𝚍𝚎𝚛𝚎𝚌𝚑𝚊 𝚍𝚎 𝚠𝚑𝚊𝚝𝚜𝚊𝚙𝚙*\n\n*⟴ 𝙸𝚛 𝚊 𝚕𝚊 𝚘𝚙𝚌𝚒𝚘́𝚗 𝚍𝚒𝚜𝚙𝚘𝚜𝚒𝚝𝚒𝚟𝚘𝚜 𝚟𝚒𝚗𝚌𝚞𝚕𝚊𝚍𝚘𝚜*\n\n*⟴ 𝙴𝚜𝚌𝚊𝚗𝚎𝚎 𝚎𝚜𝚝𝚎 𝚌𝚘𝚍𝚒𝚐𝚘 𝚀𝚁 𝚙𝚊𝚛𝚊 𝚒𝚗𝚒𝚌𝚒𝚊𝚛 𝚜𝚎𝚜𝚒𝚘́𝚗 𝚢 𝚜𝚎𝚛 𝚜𝚞𝚋 𝙱𝚘𝚝*\n\n*¡𝙴𝚜𝚝𝚎 có𝚍𝚒𝚐𝚘 𝚀𝚁 𝚎𝚡𝚙𝚒𝚛𝚊 𝚎𝚗 40 𝚜𝚎𝚐𝚞𝚗𝚍𝚘𝚜!*`}
const smsIniJadi2 = () => { return `*࿇ ═━✥${global.gt}✥━═ ࿇*\n🌹 *_𝙽𝚄𝙴𝚅𝙰 𝙵𝚄𝙽𝙲𝙸𝙾𝙽 𝙳𝙴 𝙷𝙰𝙲𝙴𝚁𝚃𝙴 𝚄𝙽 𝚂𝚄𝙱 𝙱𝙾𝚃_* 🌹\n\n
*➥ 𝙳𝚒𝚛𝚒𝚓𝚊𝚜𝚎 𝚎𝚗 𝚕𝚘𝚜 𝚝𝚛𝚎𝚜 𝚙𝚞𝚗𝚝𝚘𝚜 𝚎𝚗 𝚕𝚊 𝚎𝚜𝚚𝚞𝚒𝚗𝚊 𝚜𝚞𝚙𝚎𝚛𝚒𝚘𝚛 𝚍𝚎𝚛𝚎𝚌𝚑𝚊*\n*➥𝙸𝚛 𝚊 𝚕𝚊 𝚘𝚙𝚌𝚒𝚘𝚗 𝙳𝚒𝚜𝚙𝚘𝚜𝚒𝚝𝚒𝚟𝚘𝚜 𝚟𝚒𝚗𝚌𝚞𝚕𝚊𝚍𝚘𝚜*\n*➥ 𝚍𝚊 𝚌𝚕𝚒𝚌𝚔 𝚎𝚗 𝚟𝚒𝚗𝚌𝚞𝚕𝚊𝚛 𝚌𝚘𝚗 𝚌𝚘𝚍𝚒𝚐𝚘 𝚍𝚎 𝚝𝚎𝚕𝚎𝚏𝚘𝚗𝚘*\n*➥ 𝚙𝚎𝚐𝚊 𝚎𝚕 𝚌𝚘𝚍𝚒𝚐𝚘 𝚊 𝚌𝚘𝚗𝚝𝚒𝚗𝚞𝚊𝚌𝚒𝚘𝚗*`}
const smsSoloOwnerJB = () => { return `${lenguajeGB['smsAvisoAG']()}*ESTE COMANDO ESTÁ DESACTIVADO POR MÍ PROPIETARIO(A)*`}
const smsJBPrincipal = () => { return `${lenguajeGB['smsAvisoAG']()}𝙿𝙰𝚁𝙰 𝚂𝙴𝚁 𝚂𝚄𝙹 𝙱𝙾𝚃 𝙿𝙾𝚁 𝙵𝙰𝚅𝙾𝚁 𝙳𝙸𝚁𝙸𝙹𝙰𝚂𝙴 𝙰𝙻 𝙽𝚄𝙼𝙴𝚁𝙾 𝙿𝚁𝙸𝙲𝙸𝙿𝙰𝙻 𝙳𝙴𝙻 𝙱𝙾𝙱\n𝙸𝙽𝙶𝚁𝙴𝚂𝙴 𝙰𝙻 𝚂𝙸𝙶𝚄𝙸𝙴𝙽𝚃𝙴 𝙴𝙽𝙻𝙰𝙲𝙴\n`}
const smsreenvia = () => { return `𝚁𝙴𝙴𝙽𝚅𝙸𝙰 𝙴𝙻 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙽𝚄𝙴𝚅𝙰𝙼𝙴𝙽𝚃𝙴...`}
const smsJBConexion = () => { return `${lenguajeGB['smsAvisoFG']()}𝙻𝙰 𝙲𝙾𝙽𝙴𝚇𝙸𝙾𝙽 𝚂𝙴 𝙰𝙷 𝙲𝙴𝚁𝚁𝙰𝙳𝙾 𝙳𝙴 𝙼𝙰𝙽𝙴𝚁𝙰 𝙸𝙽𝚂𝙴𝚂𝙿𝙴𝚁𝙰𝙳𝙰, 𝚅𝙾𝙻𝚅𝙸𝙴𝙽𝙳𝙾 𝙰 𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝚁...`}
const smsJBConexionClose = () => { return `${lenguajeGB['smsAvisoFG']()}𝙻𝙰 𝙲𝙾𝙽𝙴𝚇𝙸𝙾𝙽 𝚂𝙴 𝙰𝙷 𝙲𝙴𝚁𝚁𝙰𝙳𝙾, 𝙳𝙴𝙱𝙴 𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝚁𝚂𝙴 𝙽𝚄𝙴𝚅𝙰𝙼𝙴𝙽𝚃𝙴 𝙲𝙾𝙽 𝙴𝙻 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 .serbot --code 𝚈 𝚅𝚄𝙴𝙻𝚅𝙰 𝙰 𝙸𝙽𝙶𝚁𝙴𝚂𝙰𝚁 𝙴𝙻 𝙲𝙾𝙳𝙸𝙶𝙾 𝙾 𝚀𝚁.`}
const smsJBConexionClose2 = () => { return `${lenguajeGB['smsAvisoFG']()}𝙻𝙰 𝙲𝙾𝙽𝙴𝚇𝙸𝙾𝙽 𝚂𝙴 𝙰𝙷 𝙲𝙴𝚁𝚁𝙰𝙳𝙾, 𝚃𝙴𝙽𝙳𝚁𝙰 𝚀𝚄𝙴 𝚅𝙾𝙻𝚅𝙴𝚁𝚂𝙴 𝙰 𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝚁 𝚄𝚂𝙰𝙽𝙳𝙾 𝙴𝙻 𝙲𝙾𝙼𝙰𝙽𝙳𝙾\n#deletesesion (Para borrar los datos y poder volver a solitar el QR o el code)`}
const smsJBConexionTrue = () => { return `${lenguajeGB['smsAvisoEG']()} 𝙲𝙾𝙽𝙴𝚇𝙸𝙾𝙽 𝙴𝚇𝙸𝚃𝙾𝚂𝙰`}
const smsJBConexionTrue2 = () => { return `${lenguajeGB['smsAvisoEG']()}𝙲𝙾𝙽𝙴𝚇𝙸𝙾𝙽 𝙲𝙾𝙽 𝙴𝚇𝙸𝚃𝙾, 𝙿𝚄𝙴𝙳𝙴 𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝚁𝚂𝙴 𝙽𝚄𝚅𝙰𝙼𝙽𝚃𝙴 𝚄𝚂𝙰𝙽𝙳𝙾 𝚂𝚄 (ID) 𝙾 𝚄𝚂𝙰𝚁:*`}
const smsJBCargando = () => { return `${lenguajeGB['smsAvisoIIG']()} 𝚃𝙴 𝙷𝙰𝚂 𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝙳𝙾(𝙰), 𝙿𝙾𝚁 𝙵𝙰𝚅𝙾𝚁 𝙴𝚂𝙿𝙴𝚁𝙴 𝚂𝙴 𝙴𝚂𝚃𝙰𝙽 𝙲𝙰𝚁𝙶𝙰𝙽𝙳𝙾 𝙻𝙾𝚂 𝙼𝙴𝙽𝚂𝙰𝙹𝙴𝚂...\n\n♻️ *𝙾𝙿𝙲𝙸𝙾𝙽𝙴𝚂 𝙳𝙸𝚂𝙿𝙾𝙽𝙸𝙱𝙻𝙴𝚂:*\n*» #stop\n*» #eliminarsesion\n*» #serbot`}
const smsJBInfo1 = () => { return `💖 *ENLACE ÚTIL*`}
const smsJBInfo2 = () => { return `💖 *La función es estable, sí presenta algún inconveniente Comuníquese al correo: centergatabot@gmail.com*\n💝 *Puede hacer una Donación voluntaria por PayPal: ${global.paypal}*\n\n*Muchas Gracias por el apoyo a ${global.gt}*`}

//jadibot-deleteSesion.js
const smsJBDel = () => { return `${lenguajeGB['smsAvisoAG']()}*USE ESTE COMANDO AL BOT PRINCIPAL*`}
const smsJBAdios = () => { return `${lenguajeGB['smsAvisoEG']()}*TE VOY A EXTRAÑAR ${global.gt} CHAOO!! 🥹*`}
...
//info-contacto.js
const smsContacto1 = () => { return ' Soy ' + gt + ' un Bot de WhatsApp dedicado en ayudar con lo que me pidas 😎'}
const smsContacto2 = () => { return 'Soy Owner de ' + gt + ' sí tienes alguna duda me la puedes decir ✌️'}
const smsContacto3 = () => { return '👑 Owner'}
const smsContacto4 = () => { return 'Contacto Oficial de NatsukiBot '}
...
smsIniJadi, smsCodebt, smsSscrrd, smsExit, smsExit2, smsExitcnx, smsSoloOwnerJB, smsJBPrincipal, smsJBConexion, smsJBConexionClose, smsJBConexionTrue, smsJBConexionTrue2, smsJBCargando, smsJBInfo1, smsJBInfo2, smsJBDel, smsJBAdios, 
