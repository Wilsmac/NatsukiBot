...
if wget -q https://github.com/Wilsmac/FantasyBot-MD-v1/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/Wilsmac/NatsukiBot.git
...
echo -e "\033[01;32m\033[01mIFantasyBot!!\nFantasyBot!!\n\033[0m"
npm start
