 ...
 *${lenguajeCD['smsBanUsers']()}* ➺ _${Object.entries(global.db.data.users).filter(user => user[1].banned).length}_ `.trim()
...
header: { title: `\`Hola\` ${taguser}*\n*_CENTRÓ DE CONFIGURACIÓN_*`, subtitle: "test4", hasMediaAttachment: false },
