...
let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Wilmer, tu seras NatsukiBot`;
...
try {
const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Wilmer, tu seras NatsukiBot.`;
