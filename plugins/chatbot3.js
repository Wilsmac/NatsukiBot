...
let pp = await conn.profilePictureUrl(conn.user.jid).catch(_ => 'https://telegra.ph/file/05ebdbb38072ac3abb72d.jpg')
...
conn.reply(m.chat, `* Ocurrió un fallo*`, m, a, )
console.log(e)
}}
handler.help = ['prueba90']
handler.tags = ['bot']
handler.command = /^(prueba90)$/i
