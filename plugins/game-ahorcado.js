const palabras = ["gato", "perro", "elefante", "tigre", "ballena", "mariposa", "tortuga", "conejo", "rana", "pulpo", "ardilla", "jirafa", "cocodrilo", "pingüino", "delfín", "serpiente", "hámster", "mosquito", "abeja", "negro", "television", "computadora", "botsito", "reggaeton", "economía", "electrónica", "facebook", "WhatsApp", "Instagram", "tiktok", "presidente", "bot", "películas", "undefined", "Natsuki", 
]
...
function juegoTerminado(sender, mensaje, palabra, letrasAdivinadas, intentos) {
    if (intentos === 0) {
        gam.delete(sender);
        return `*𝚂𝙴 𝙰𝙶𝙾𝚃𝙰𝚁𝙾𝙽 𝙻𝙾𝚂 𝙸𝙽𝚃𝙴𝙽𝚃𝙾𝚂*, 𝙻𝙰 𝙿𝙰𝙻𝙰𝙱𝚁𝙰 𝙴𝚁𝙰: ${palabra}\n\n${mostrarAhorcado(intentos)}`;
