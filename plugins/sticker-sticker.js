...
if (new Date - user.lastmiming < 10000) return await conn.reply(m.chat, `*ESPERA UNOS MINUTOS PARA USAR OTRO COMANDO*`,  m)
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `> ⓘ _𝚁𝙴𝙲𝚄𝙴𝚁𝙳𝙰 𝚁𝙴𝚂𝙿𝙾𝙽𝙳𝙴𝚁 𝙰 𝚄𝙽𝙰 𝙸𝙼𝙰𝙶𝙴𝙽 𝙾 𝚄𝙽 𝙴𝙽𝙻𝙰𝙲𝙴 𝚀𝚄𝙴 𝚃𝙴𝚁𝙼𝙸𝙽𝙴 𝙲𝙾𝙽 \`.jpg o .png\` 𝚈 𝚅𝚄𝙴𝙻𝚅𝙰 𝙰 𝙸𝙽𝚃𝙴𝙽𝚃𝙰𝚁𝙻𝙾 𝙲𝙾𝙽 𝙴𝙻 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 ${usedPrefix + command}_`, FakeChannel
      let out
      try {
      ...
      await conn.reply(m.chat, `*CREANDO STICKER, UN MOMENTO POR FAVOR...*`, m)
        if (!stiker) {
    ...
    else throw `> ⓘ _𝚁𝙴𝙲𝚄𝙴𝚁𝙳𝙰 𝚁𝙴𝚂𝙿𝙾𝙽𝙳𝙴𝚁 𝙰 𝚄𝙽𝙰 𝙸𝙼𝙰𝙶𝙴𝙽 𝙾 𝚄𝙽 𝙴𝙽𝙻𝙰𝙲𝙴 𝚀𝚄𝙴 𝚃𝙴𝚁𝙼𝙸𝙽𝙴 𝙲𝙾𝙽 \`.jpg o .png\` 𝚈 𝚅𝚄𝙴𝙻𝚅𝙰 𝙰 𝙸𝙽𝚃𝙴𝙽𝚃𝙰𝚁𝙻𝙾 𝙲𝙾𝙽 𝙴𝙻 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 ${usedPrefix + command}_`, FakeChannel
  }
