...
let imagen = './media/menus/Menu1.jpg'
...
let fakemek = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "51995386439-1616969743@g.us","inviteCode": "m","groupName": "P", "caption": '𝐅𝐚𝐧𝐭𝐚𝐬𝐲𝐁𝐨𝐭-𝐌𝐃', 'jpegThumbnail': imagen}}}
...
─━━━━┉❈⏤͟͟͞͞★꙲⃝͟🌻❈┉━━━━─
*hola :D*`
await conn.sendFile(m.chat, imagen, 'error.jpg', str, fakemek)}
