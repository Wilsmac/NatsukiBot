...
let pol = { key: { fromMe: false, participant: "0@s.whatsapp.net", ...(false ? { remoteJid: "17608914335@s.whatsapp.net" } : {}) }, message: { productMessage: { product: { productImage:{ "mimetype": "image/jpeg", jpegThumbnail: imagen1 }, title: uwu, description: "FantasyBot-MD", currencyCode: "USD", priceAmount1000: "200000000", retailerId: "Ghost", productImageCount: 1 }, businessOwnerJid: "0@s.whatsapp.net" }}}
...
─━━━━┉❈⏤͟͟͞͞★꙲⃝͟🌻❈┉━━━━─
*hola :D*`
await conn.sendFile(m.chat, media, 'fantasy.mp4', str, pol)}
