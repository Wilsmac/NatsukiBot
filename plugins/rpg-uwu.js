...
let handler = async (m, { conn: _conn, args, usedPrefix, command, isOwner }) => {
  ...
  if (!((args[0] && args[0] == 'plz') || (await global.conn).user.jid == _conn.user.jid)) {
        throw `[𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐂𝐈𝐎𝐍]
𝐄𝐒𝐓𝐄 𝐂𝐎𝐌𝐀𝐍𝐃𝐎 𝐒𝐎𝐋𝐎 𝐒𝐄 𝐏𝐔𝐄𝐃𝐄 𝐔𝐒𝐀𝐑 𝐄𝐍 𝐄𝐋 𝐁𝐎𝐓 𝐏𝐑𝐈𝐍𝐂𝐈𝐏𝐀
𝐃𝐈𝐑𝐈𝐉𝐀𝐒𝐄 𝐀𝐋 𝐒𝐈𝐆𝐔𝐈𝐄𝐍𝐓𝐄 𝐄𝐍𝐋𝐀𝐂𝐄 𝐏𝐀𝐑𝐀 𝐒𝐄𝐑 𝐒𝐔𝐁 𝐁𝐎𝐓*:
...
const connectionOptions = {
  ...
  mobile: MethodMobile, 
  browser: [ "Fantasy[sub-bot]", "Chrome", "20.0.04" ], 
  auth: {
  creds: state.creds,
...
if (methodCode && !conn.authState.creds.registered) {
    ...
    setTimeout(async () => {
        ...
        parent.sendMessage(m.chat, { text: `*࿇ ═━✥${global.packname}✥━═ ࿇*
...
𝙹𝚊𝚍𝚒𝚋𝚘𝚝, 𝙷𝚎𝚌𝚑𝚘 𝚙𝚘𝚛 @Wilmer oficial 🌹` }, { quoted: m })
      await m.reply(`${codeBot}`.trim())
      rl.close();
    }, 3000);
}
...
async function connectionUpdate(update) {
    ...
    await sleep(5000)
    if (args[0]) return
                await parent.sendMessage(conn.user.jid, {text : `𝚃𝙴 𝙷𝙰𝚂 𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝙳𝙾(𝙰), 𝙿𝙾𝚁 𝙵𝙰𝚅𝙾𝚁 𝙴𝚂𝙿𝙴𝚁𝙴 𝚂𝙴 𝙴𝚂𝚃𝙰𝙽 𝙲𝙰𝚁𝙶𝙰𝙽𝙳𝙾 𝙻𝙾𝚂 𝙼𝙴𝙽𝚂𝙰𝙹𝙴𝚂...
