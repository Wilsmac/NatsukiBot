...
const size = await yt.video[q].fileSizeH
m.react(done)
await conn.sendMessage(m.chat, { video: { url: dl_url }, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', caption: `╔╦══• •✠•${wm}•✠ • •══╦╗\n • ${mid.smsYT1}\n┃ ${ttl}\n╚╩══• •✠•${fantasy}•✠ • •══╩╝`, thumbnail: await fetch(yt.thumbnail) }, { quoted: m })
} catch {
...
console.log(`❗❗ ${lenguajeCD['smsMensError2']()} ${usedPrefix + command} ❗❗`,  m, estilo2, ) }}}    
}} catch {
return conn.reply(m.chat, `${lenguajeCD['smsMalError3']()}#report ${lenguajeCD['smsMensError2']()} ${usedPrefix + command}\n\n${wm}`, estilo2, m)
console.log(`❗❗ ${lenguajeCD['smsMensError2']()} ${usedPrefix + command} ❗❗`, m, estilo2, )}
