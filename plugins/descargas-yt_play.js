...
if (size.split('MB')[0] >= limit) return conn.reply(m.chat,`El archivo pesa mas de ${limit} MB, se canceló la Descarga.`, m, canalofc).then(_ => m.react('✖️'))
...
await conn.sendFile(m.chat, vid.thumbnail, 'thumbnail.jpg', txt, m, canalofc)
try {
...
await conn.sendFile(m.chat, dl_url, 'yt.jpg', `${vid.title}\n⇆ㅤㅤ◁ㅤㅤ❚❚ㅤㅤ▷ㅤㅤ↻\n00:15 ━━━━●────── ${vid.timestamp}`, m, null, canalofc)
await m.react('✅')
} catch {
try {
