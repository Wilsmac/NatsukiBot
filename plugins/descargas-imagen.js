...
if (!text) throw `️${lenguajeGB['smsAvisoMG']()}${mid.smsMalused7} *${usedPrefix + command} cuyo*`
...
let link = image
conn.sendButton(m.chat, `${mid.buscador}: ${text}`, wm, link, [['𝚂 𝙸 𝙶 𝚄 𝙸 𝙴 𝙽 𝚃 𝙴', `/imagen ${text}`]], null, null, m)
